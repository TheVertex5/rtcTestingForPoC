...
def get_room_parameters(request, room_id, client_id, is_initiator):
  ...
  logging.info("    ICE check response_type: "+response_type)
  ...
  logging.info("    ICE check ice_transports: "+ice_transports)
  ...
  logging.info("    ICE check ice_server_transports: "+ice_server_transports)
  ...
  logging.info("    ICE check ice_server_base_url: "+ice_server_base_url)
